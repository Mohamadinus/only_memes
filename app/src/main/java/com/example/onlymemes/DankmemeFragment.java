...
public class DankmemeFragment extends Fragment {
    ...
    Button btn1,btn2;
    public String URL = "https://meme-api.herokuapp.com/gimme/dankmeme";
    public DankmemeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dankmeme, container, false);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Glide.with(DankmemeFragment.this).load(currentImageurl).into(imageView);
